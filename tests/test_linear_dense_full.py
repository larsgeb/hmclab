"""A collection of tests for the _LinearMatrix_dense_forward_dense_covariance class.
"""
...
def test_creation(
    ...
    _LinearMatrix_dense_forward_dense_covariance class under varying circumstances."""
    ...
    # Create distribution
    distribution = _LinearMatrix_dense_forward_dense_covariance(
        G,
        d,
...
def test_misfit(
    ...
    the _LinearMatrix_dense_forward_dense_covariance class under varying circumstances.
...
def test_misfit_bounds(
    ...
    """This check assesses whether or not we can compute the misfit of an instance of
    the _LinearMatrix_dense_forward_dense_covariance class when the distribution
