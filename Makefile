...
release:          ## Create a new tag for release.
	...
	@read -p "Version? (provide the next x.y.z semver) : " input; \
	TAG="$$input"; \
	echo "Tag: $${TAG}"; \
	echo "$${input}" > $(PROJECT_NAME)/VERSION; \
...
docs:             ## Build the documentation.
	...
	URL="site/index.html"; xdg-open $$URL || sensible-browser $$URL || x-www-browser $$URL || gnome-open $$URL || open $$URL || echo "Unable to open $$URL"
